...
class WorkspacesNamespace(APINamespace):
    ...
    def delete_async(self, project_uid: str, workspace_uid: str, /) -> None: ...
...
class ProjectsNamespace(APINamespace):
    ...
    def delete(self, project_uid: str, /) -> Project: ...
    def delete_async(self, project_uid: str, /) -> None: ...
    ...
    def refresh_size_async(self, project_uid: str, /) -> None: ...
